...
const SkillsCardBox = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-6 w-full'>
      {skills.map((skill)=>(
        <div className='w-[330px] md:w-[340px] lg:w-full flex justify-center items-center bg-sky-50 h-60 rounded shadow-sm hover:border-b-4 rounded-b-md border-purple-700 px-4 ' key={skill.id}>
